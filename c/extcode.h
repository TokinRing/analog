...
#define rcsid_extcode "$Id: //lvdist/branches/Constellation/dev/plat/win/cintools/extcode.h#16 $"
...
TH_REENTRANT CStr _FUNCC		StrNCpy(CStr, ConstCStr, int32);
TH_REENTRANT int32 _FUNCC	StrCmp(ConstCStr, ConstCStr);
TH_REENTRANT int32 _FUNCC	StrNCmp(ConstCStr, ConstCStr, int32);
TH_REENTRANT int32 _FUNCC	StrNCaseCmp(ConstCStr, ConstCStr, int32);
...
TH_REENTRANT int32 _FUNCC	AZGetHandleSize(const void *h);
...
TH_REENTRANT UHandle _FUNCC	AZNewHandle(int32);
TH_REENTRANT UHandle _FUNCC	AZNewHClr(int32);
TH_REENTRANT UPtr _FUNCC		AZNewPtr(int32);
TH_REENTRANT UPtr _FUNCC		AZNewPClr(int32);
TH_REENTRANT UHandle _FUNCC	AZRecoverHandle(void *p);
TH_REENTRANT MgErr _FUNCC	AZSetHandleSize(void *h, int32);
TH_REENTRANT MgErr _FUNCC	AZSetHSzClr(void *h, int32);
TH_REENTRANT int32 _FUNCC	AZHeapCheck(Bool32);
TH_REENTRANT int32 _FUNCC	AZMaxMem(void);
TH_REENTRANT MgErr _FUNCC	AZMemStats(MemStatRec *msrp);
TH_REENTRANT MgErr _FUNCC	AZCopyHandle(void *ph, const void *hsrc);
TH_REENTRANT MgErr _FUNCC	AZSetHandleFromPtr(void *ph, const void *psrc, int32 n);
...
TH_REENTRANT int32 _FUNCC	DSGetHandleSize(const void *h);
TH_REENTRANT UHandle _FUNCC DSNewHandle(int32);
TH_REENTRANT UHandle _FUNCC	DSNewHClr(int32);
TH_REENTRANT UPtr _FUNCC		DSNewPtr(int32);
TH_REENTRANT UPtr _FUNCC		DSNewPClr(int32);
TH_REENTRANT UHandle _FUNCC	DSRecoverHandle(void *p);
TH_REENTRANT MgErr _FUNCC	DSSetHandleSize(void *h, int32);
TH_REENTRANT MgErr _FUNCC	DSSetHSzClr(void *h, int32);
TH_REENTRANT MgErr _FUNCC	DSCopyHandle(void *ph, const void *hsrc);
TH_REENTRANT MgErr _FUNCC	DSSetHandleFromPtr(void *ph, const void *psrc, int32 n);
...
TH_REENTRANT MgErr _FUNCC	DSSetHandleFromPtrNULLMeansEmpty(void *ph, const void *psrc, int32 n);
TH_REENTRANT int32 _FUNCC	DSHeapCheck(Bool32);
TH_REENTRANT int32 _FUNCC	DSMaxMem(void);
TH_REENTRANT MgErr _FUNCC	DSMemStats(MemStatRec *msrp);
TH_REENTRANT void _FUNCC		ClearMem(void*, int32);
TH_REENTRANT void _FUNCC		MoveBlock(const void *src, void *dest, int32); // accepts zero bytes without problem
TH_REENTRANT void _FUNCC		SwapBlock(void *src, void *dest, int32);
#else
TH_REENTRANT UHandle _FUNCC	DSNewHandle(int32);
TH_REENTRANT UHandle _FUNCC	DSNewHClr(int32);
TH_REENTRANT UPtr _FUNCC		DSNewPtr(int32);
